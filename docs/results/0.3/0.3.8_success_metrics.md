...
This document defines the 5 core success metrics for Prio MVP. These metrics will guide product decisions, measure success, and serve as leading indicators for product-market fit.
...
- Users who complete tasks see Prio as valuable
