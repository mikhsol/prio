...
This document provides a comprehensive technical comparison of small language models suitable for on-device inference on Android smartphones. Our primary use case is **natural language task parsing and Eisenhower Matrix classification** for the Jeeves personal assistant.
