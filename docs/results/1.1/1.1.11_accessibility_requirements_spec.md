...
This document defines accessibility requirements for Prio MVP, ensuring the app is usable by people with visual, motor, auditory, and cognitive disabilities. We target WCAG 2.1 AA compliance.
...
| Element Type | Minimum Ratio | Prio Standard |
|--------------|---------------|-----------------|
...
| Element | Minimum Size | Prio Standard |
|---------|--------------|-----------------|
