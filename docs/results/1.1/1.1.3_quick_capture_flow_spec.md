...
│  ┌──────┐       ┌──────┐        ┌──────┐       ┌──────┐         │
│  │ FAB  │ ───►  │Input │ ───►   │Parse │ ───► │Saved │         │
│  │ Tap  │       │Focus │        │Preview│      │ ✓    │         │
│  └──────┘       └──────┘        └──────┘       └──────┘         │
│                                                                   │
│  <100ms         Immediate        <2s           <500ms            │
│                 keyboard                                          │
│                                                                   │
│  TOTAL TIME TARGET: <5 seconds from FAB tap to task saved        │
│                                                                   │
└──────────────────────────────────────────────────────────────────┘
```
...
```
    ┌──────────────────────┐
    │  ➕   Add Task        │  Extended FAB
    └──────────────────────┘
```

**First-Time User Behavior** (sessions 1-3):
```
    ┌──────────────────────┐
    │  ➕   Add Task        │  Extended FAB (always visible)
    └──────────────────────┘
```
> 📝 **Usability Finding**: First-time users may not immediately recognize the FAB.
> Show extended FAB label for first 3 app sessions to improve discoverability.
> After 3 sessions, revert to standard FAB behavior (extends on scroll-up).
...
│                                                                  │
│  ┌────────────────────────────────────────────────────────────┐ │
│  │ 🎤🔒  |  Type or speak (on-device)               [✕]    │ │ ← Input field
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
│  ──────────────────────────────────────────────────────────────  │
│                                                                  │
...
| Placeholder | "Type or speak (on-device)" |
| Font | Body Large |

> 📝 **Privacy Note**: The "🔒" icon and "(on-device)" text reassure privacy-conscious
> users that voice input is processed locally. This addresses usability finding QC-02.

### Elements

| Element | Position | Behavior |
|---------|----------|----------|
| Voice Icon 🎤🔒 | Left | Tap to start voice input (on-device processing) |
| Text Input | Center | Auto-focused, single line |
| Close Button ✕ | Right | Dismisses capture, returns to previous |

> The lock icon (🔒) next to the voice icon indicates on-device processing,
> addressing privacy concerns from Maya persona during usability testing.
...
│  ┌────────────────────────────────────────────────────────────┐ │
│  │                                                             │ │
│  │  "Call dentist about appointment tomorrow..."              │ │ ← Live transcription
│  │                                                             │ │
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
│                     [■ Stop]                                     │
...
│  ──────────────────────────────────────────────────────────────  │
│                                                                  │
│  🤖 Understanding...                                             │ ← Shimmer animation
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
...
│  ┌────────────────────────────────────────────────────────────┐ │
│  │                                                             │ │
│  │  📋  Call dentist                                   [✏️]   │ │ ← Title (editable)
│  │                                                             │ │
│  │  📅  Tomorrow (Feb 5) at 2:00 PM                    [✏️]   │ │ ← Date/time
│  │                                                             │ │
│  │  🔴  DO FIRST                                       [✏️]   │ │ ← Quadrant
│  │      "Health appointment + specific time"                   │ │
│  │                                                             │ │
│  │  🎯  No goal linked                                 [➕]   │ │ ← Goal (optional)
│  │                                                             │ │
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
...
|-------|-------------|----------|
| Title | Main action text | Yes (tap ✏️) |
| Due Date | Temporal expressions | Yes (tap ✏️) |
| Due Time | Time expressions | Yes (tap ✏️) |
| Quadrant | AI classification | Yes (tap ✏️) |
| Goal | AI suggestion | Yes (tap ➕) |
...
```
┌────────────────────────────────────────────────────────────────┐
│  📅  Tomorrow (Feb 5) at 2:00 PM                 High ⬤⬤⬤    │ ← High confidence
│  📅  Maybe next week?                            Low  ⬤○○    │ ← Low confidence
└────────────────────────────────────────────────────────────────┘
```
...
│                                                                  │
│  ┌────────────────────────────────────────────────────────────┐ │
│  │ 🎤  urgent meeting with client friday                [✕]   │ │
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
│  ──────────────────────────────────────────────────────────────  │
│                                                                  │
│  ┌────────────────────────────────────────────────────────────┐ │
│  │                                                             │ │
│  │  📋  urgent meeting with client friday             [✏️]   │ │ ← Full text as title
│  │                                                             │ │
│  │  📅  No due date                                   [➕]   │ │ ← Manual add
│  │                                                             │ │
│  │  ⚪  Uncategorized                                  [✏️]   │ │ ← Default
│  │      🤖 AI will classify in background                      │ │
│  │                                                             │ │
│  └────────────────────────────────────────────────────────────┘ │
│                                                                  │
│  [Edit Details]                               [✓ Create Task]   │
