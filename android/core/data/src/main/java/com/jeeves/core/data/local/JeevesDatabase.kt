package com.jeeves.core.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import com.jeeves.core.data.local.converter.JeevesTypeConverters
...
import com.jeeves.core.data.local.entity.DailyAnalyticsEntity
import com.jeeves.core.data.local.entity.GoalEntity
import com.jeeves.core.data.local.entity.MeetingEntity
import com.jeeves.core.data.local.entity.MilestoneEntity
import com.jeeves.core.data.local.entity.TaskEntity

/**
 * Main Room database for Jeeves application.
 * 
...
@TypeConverters(JeevesTypeConverters::class)
abstract class JeevesDatabase : RoomDatabase() {
    ...
    companion object {
        const val DATABASE_NAME = "jeeves_database"
    }
}
